<template >
  <div class="login-container">
    <el-card class="login-card" >
      <div class="login-title">传统村落可视化系统</div>
      <!-- 选项卡切换 -->
        ...
        <el-tab-pane label="注册" name="register">
          ...
          >
            ...
            <el-form-item label="用户头像" prop="avatar">
              <el-select v-model="registerForm.avatar" placeholder="请选择头像" style="width: 130px;">
                <el-option
...
const avatarOption=ref<Array<{value:string;label:string}>>([ {value:'/img/dog.svg',label:'小狗'},{value:'/img/青蛙.svg',label:'青蛙'},{value:'/img/小猫.svg',label:'小猫'},{value:'/img/小猴.svg',label:'小猴'},])
// 登录表单数据
...
.login-container {
  ...
  align-items: center;
  height: 100vh;
  background-image: url('/img/登录bg.jpg'); /* 设置背景图片 */
...
.el-form {
  padding-right: 10px; /* 给表单设置左侧内边距，使内部元素左移 */
}
/* 或者调整表单项的对齐 */
.el-form-item {
  margin-left: -15px; /* 负的左边距，使表单项左移 */
  margin-top: 10px;
}

/* 浅绿色主按钮样式 */
:deep(.el-button--primary) {
  background-color: #68b7a2; /* 基础浅绿色 */
  color: white; /* 文字白色，保证对比度 */
  border-color: #68b7a2; /* 边框与背景色一致 */
}
